...
public class HousieGameStateTest {
    ...
    public List<HousieTicket> initTicketsForTwoPlayers() {
        ...
        Block[][] testTicket2 = new Block[][]{
                {Block.builder().number(11).selected(false).build(), null, Block.builder().number(3213).selected(false).build(), null, Block.builder().number(434).selected(false).build()},
                {Block.builder().number(21).selected(false).build(), null, Block.builder().number(12).selected(false).build(), null, Block.builder().number(13).selected(false).build()},
                {Block.builder().number(333).selected(false).build(), null, Block.builder().number(6666).selected(false).build(), null, Block.builder().number(555).selected(false).build()},
        };
